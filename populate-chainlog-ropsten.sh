...
[[ "$ETH_RPC_URL" && "$(seth chain)" == "ropsten"  ]] || { echo "Please set a ropsten ETH_RPC_URL"; exit 1;  }

CHAINLOG=0xda0ab1e0017debcd72be8599041a2aa3ba7e740f
GAS_PRICE=1000000000
ETH_GAS=500000

key_vals=$(curl https://changelog.makerdao.com/releases/ropsten/1.0.4/contracts.json | jq -c -r 'keys[] as $k | "\($k)=\( .[$k])"')
